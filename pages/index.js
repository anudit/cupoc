...
function Column({background, logo, title, shortDescription, longDescription, link}){
  ...
  return (
    <Flex
      display="flex"
      width={{base:"100%",md: "calc((100vw - 500px) / 3)" }}
      height="100%"
      p= "30px"
    ...
    >
      ...
      <Flex flexDirection="column">
        ...
        <Text className="showOnHover" display="none" fontSize="sm" fontWeight={400} color="inherit">
          {longDescription}
        </Text>
      </Flex>
      <Flex className="showOnHover" display="none"  minWidth="100px">
        {logo}
      </Flex>
    </Flex>
  )
...
export default function Home() {
  return (
    <>
      ...
      <Flex overflow={{base:"scroll", md:"hidden"}} flexDirection="column" width="100%" height="100vh"  alignItems="center" justifyContent="space-between">
        <Navbar/>
        <Flex direction={{base:"column", md:"row"}} m="0px" width="100%" height="calc(100vh - 60px)">
          <Flex display="flex"
          ...
          <Column
            ...
            title="Omnid"
            shortDescription= "The Decentralized Identity Layer of Internet"
            longDescription={
              <Text fontWeight={400} color="whiteAlpha.700" lineHeight="22px" fontSize="sm">
